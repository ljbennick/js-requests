...
const backgroundStyle = (event) => {
    ...
    sayHelloButton.style.color = "#EFEFEF"
}

sayHelloButton.addEventListener('mouseover', backgroundStyle)
...
const keepColor = (event) => {
    sayHelloButton.style.backgroundColor = "#EFEFEF"
    sayHelloButton.style.color = "black"

}
sayHelloButton.addEventListener('mouseout', keepColor)
...
const repeatMyParam = () => {
    ...
    return axios.get('http://localhost:3000/repeat/Coding-Yay')
    .then(res => {
...
const test = (res =>{
axios.get('http://localhost:3000/query-test/?people=stuff&snow=cold')
.then(res => {
console.log(res.data)
})
})
let queryButton = document.querySelector("#query-button")
queryButton.addEventListener("click", test)
